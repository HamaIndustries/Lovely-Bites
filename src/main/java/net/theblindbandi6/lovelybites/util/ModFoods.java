...
public class ModFoods {
    ...
    public static final FoodProperties STRAWBERRY_JAM = new FoodProperties.Builder().nutrition(6).saturationModifier(0.3F).build();
    public static final FoodProperties CHOCOLATE = new FoodProperties.Builder().nutrition(4).saturationModifier(0.2F).build();
