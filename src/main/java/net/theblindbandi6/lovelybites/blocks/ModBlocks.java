...
import net.theblindbandi6.lovelybites.blocks.custom.StrawberryBushBlock;
...
public class ModBlocks {
    ...
    private static ResourceKey<Block> keyOfBlock(String name) {
        return ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(LovelyBites.MOD_ID, name));
    }

    private static ResourceKey<Item> keyOfItem(String name) {
        return ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(LovelyBites.MOD_ID, name));
    }
